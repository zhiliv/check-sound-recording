<template>
  <div class="col-span-12 mx-4 h-[80px]">
...
watch(data.value, (newVal) => {
  isValid.value.name = Boolean(newVal.name && newVal.name.length && newVal.name.length >= 1) // Установка валидации для поля "Наименование"
